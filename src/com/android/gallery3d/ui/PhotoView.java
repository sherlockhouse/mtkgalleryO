...
/// @}
    ...
    class FullPicture implements Picture {
        ...
        public void reload() {
            ...
            /// M: [FEATURE.ADD] plugin @{
            //  In SinglePhotoDataAdapter screenNail maybe is null, it will clear right MediaData
...
//        }
    ...
    public void updateFullPicture(MediaItem mediaItem) {
        if (mediaItem == null) {
            Log.d(TAG, "<updateFullPicture> mediaItem is null, return");
            return;
        }
        Picture p = mPictures.get(0);
        p.updateMediaData(mediaItem.getMediaData());
        GalleryPluginUtils.getImageOptionsPlugin().updateBoxMediaData(mPositionController, 0,
                mediaItem.getMediaData());
    }
    /// @}
