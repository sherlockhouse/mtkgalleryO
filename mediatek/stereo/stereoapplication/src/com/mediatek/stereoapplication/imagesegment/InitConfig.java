...
/**
 * This config information used to initialize image segment.<p>
 * Use function:<br>
 * {@link com.mediatek.stereoapplication.StereoApplication#initialize(String, Object)}<br>
 * featureName : imagesegment<br>
 * config      : {@link InitConfig} <br>
 */
public class InitConfig {

    /**
     * Original image that used to do segment.
     */
    ...
    /**
     * Forground mask, can be null.
     */
    public MaskBuf maskBuf;
    ...
    /**
     * Face number in original image.
     */
    public int faceNum;

    /**
     * Faces region and orientation in original image.
     */
    public FaceInfo[] faceInfos;

    /**
     * Face region and orientation in original image.
     */
