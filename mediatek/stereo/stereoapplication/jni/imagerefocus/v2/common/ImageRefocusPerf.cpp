...
ImageRefocusPerf::ImageRefocusPerf()
{
    ...
    LOGD("<ImageRefocusPerf><comp> ImageRefocusPerf(v2), m_powerHal: %p",
            &m_powerHal);
}
...
void ImageRefocusPerf::refocusPerfSrvEnable()
{
    ...
    LOGD("<refocusPerfSrvEnable><comp> ImageRefocusPerf(v2), scenario: %d",
...
void ImageRefocusPerf::refocusPerfSrvDisable()
{
    ...
    LOGD("<refocusPerfSrvDisable><comp> ImageRefocusPerf(v2), scenario: %d",
            GALLERY_STEREO_SCENARIO);
