...
$(info "##### MT6755 --> build valid libjni_depthgenerator  #####")
...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_SOURCE)/hardware/mtkcam/legacy/platform/$(shell echo $(MTK_PLATFORM) | tr '[A-Z]' '[a-z]')/include/mtkcam/drv
...
# MT6755 algo related lib
LOCAL_SHARED_LIBRARIES += libcamalgo

else
$(info "##### NONE-MT6755 --> build dummy libjni_depthgenerator  #####")
...
LOCAL_SRC_FILES:= \
  ./dummycreator/DepthGeneratorCreator.cpp
...
LOCAL_MODULE:= libjni_depthgenerator
