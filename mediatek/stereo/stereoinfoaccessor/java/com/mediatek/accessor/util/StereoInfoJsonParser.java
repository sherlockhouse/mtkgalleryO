...
public class StereoInfoJsonParser {
    private final static String TAG = Log.Tag(StereoInfoJsonParser.class.getSimpleName());

    public final static String VERIFY_GEO_INFO_TAG = "verify_geo_data";
    public final static String VERIFY_GEO_INFO_LEVEL = "quality_level";
    ...
    private final static String FOCUS_INFO_TAG = "focus_info";
    private final static String FOCUS_INFO_IS_FACE = "is_face";
    private final static String FOCUS_INFO_FACE_RATIO = "face_ratio";
    private final static String FOCUS_INFO_DAC_CUR = "dac_cur";
    private final static String FOCUS_INFO_DAC_MIN = "dac_min";
    private final static String FOCUS_INFO_DAC_MAX = "dac_max";
    private final static String FOCUS_INFO_FOCUS_TYPE = "focus_type";
     ...
     *            jsonString
     */
    public StereoInfoJsonParser(String jsonString) {
     ...
     *            jsonBuffer
     */
    public StereoInfoJsonParser(byte[] jsonBuffer) {
    ...
    public byte[] getMaskBuffer() {
        ...
        int[][] encodedMaskArray = mParser
                .getInt2DArrayFromObject(MASKINFO_TAG, MASKINFO_MASK);
    ...
    public int getTouchCoordX1st() {
        ...
        int left = mParser.getValueIntFromObject(TOUCH_COORD_INFO_TAG, null,
    ...
    public int getFocusTop() {
        int top =
                mParser.getValueIntFromObject(TOUCH_COORD_INFO_TAG, null, TOUCH_COORD_INFO_TOP);
        Log.d(TAG, "<getFocusTop> top: " + top);
        return top;
    }
    ...
    public int getFocusLeft() {
        int left =
                mParser.getValueIntFromObject(TOUCH_COORD_INFO_TAG, null, TOUCH_COORD_INFO_LEFT);
        Log.d(TAG, "<getFocusLeft> left: " + left);
        return left;
    }
    ...
    public int getFocusRight() {
        int right =
                mParser.getValueIntFromObject(TOUCH_COORD_INFO_TAG, null, TOUCH_COORD_INFO_RIGHT);
        Log.d(TAG, "<getFocusRight> top: " + right);
        return right;
    }
    ...
    public int getFocusBottom() {
        int bottom =
                mParser.getValueIntFromObject(TOUCH_COORD_INFO_TAG, null, TOUCH_COORD_INFO_BOTTOM);
        Log.d(TAG, "<getFocusBottom> bottom: " + bottom);
        return bottom;
    }
    ...
    public String getGImageMime() {
        String gImageMime = mParser.getValueStringFromObject(GIMAGEINFO_TAG, null,
                GIMAGEINFO_MIME);
    ...
    public double getGDepthFar() {
        double gDepthFar = mParser.getValueIntFromObject(GDEPTHINFO_TAG, null, GDEPTHINFO_FAR);
     ...
     */
    public int getDof() {
        int dof = mParser.getValueIntFromObject(null, null, DOF_LEVEL_TAG);
    ...
    public float getConvOffset() {
        float offset = (float) mParser.getValueDoubleFromObject(null, null, CONV_OFFSET_TAG);
        Log.d(TAG, "<getConvOffset>  " + offset);
        return offset;
    }
    ...
    public boolean getFaceFlag() {
        boolean isFace =
                mParser.getValueBooleanFromObject(FOCUS_INFO_TAG, null, FOCUS_INFO_IS_FACE);
        Log.d(TAG, "<getFaceFlag> FocusInfo.isFace: " + isFace);
        return isFace;
    }
    ...
    public double getFaceRatio() {
        double faceRatio =
                mParser.getValueDoubleFromObject(FOCUS_INFO_TAG, null, FOCUS_INFO_FACE_RATIO);
        Log.d(TAG, "<getFaceRatio> FocusInfo.faceRatio: " + faceRatio);
        return faceRatio;
    }
    ...
    public int getCurDac() {
        int curDac = mParser.getValueIntFromObject(FOCUS_INFO_TAG, null, FOCUS_INFO_DAC_CUR);
        Log.d(TAG, "<getFocusInfo> FocusInfo.curDac: " + curDac);
        return curDac;
    }
    ...
    public int getMinDac() {
        int minDac = mParser.getValueIntFromObject(FOCUS_INFO_TAG, null, FOCUS_INFO_DAC_MIN);
        Log.d(TAG, "<getFocusInfo> FocusInfo.minDac: " + minDac);
        return minDac;
    }
    ...
    public int getMaxDac() {
        int maxDac = mParser.getValueIntFromObject(FOCUS_INFO_TAG, null, FOCUS_INFO_DAC_MAX);
        Log.d(TAG, "<getFocusInfo> FocusInfo.maxDac: " + maxDac);
        return maxDac;
    }
    ...
    public int getFocusType() {
        int type = mParser.getValueIntFromObject(FOCUS_INFO_TAG, null, FOCUS_INFO_FOCUS_TYPE);
        Log.d(TAG, "<getFocusType> FocusInfo.focusType: " + type);
        return type;
    }
    ...
    public int getMetaBufferWidth() {
        int metaWidth = mParser.getValueIntFromObject(DEPTH_INFO_TAG, null, DEPTH_INFO_META_WIDTH);
        Log.d(TAG, "<getMetaBufferWidth> metaWidth: " + metaWidth);
        return metaWidth;
    }
    ...
    public int getMetaBufferHeight() {
        int metaHeight = mParser.getValueIntFromObject(DEPTH_INFO_TAG, null,
                DEPTH_INFO_META_HEIGHT);
        Log.d(TAG, "<getMetaBufferHeight> metaHeight: " + metaHeight);
        return metaHeight;
    }
    ...
    public int getDepthBufferWidth() {
        int depthWidth = mParser.getValueIntFromObject(DEPTH_INFO_TAG, null,
                DEPTH_INFO_DEPTH_WIDTH);
        Log.d(TAG, "<getDepthBufferWidth> depthWidth: " + depthWidth);
        return depthWidth;
    }
    ...
    public int getDepthBufferHeight() {
        int depthHeight = mParser.getValueIntFromObject(DEPTH_INFO_TAG, null,
                DEPTH_INFO_DEPTH_HEIGHT);
        Log.d(TAG, "<getDepthBufferHeight> depthHeight: " + depthHeight);
        return depthHeight;
    }
    ...
    private byte[] decodeMaskBuffer(int[][] encodedMaskArray, int maskSize) {
        ...
        for (int i = 0; i < encodedMaskArray.length; i++) {
            ...
            if (startIndex > maskSize || startIndex < 0 || endIndex < 0 || endIndex > maskSize) {
                Log.d(TAG, "<decodeMaskBuffer> error, startIndex: " + startIndex
                        + ", endIndex: " + endIndex + ", maskSize: " + maskSize);
                return null;
            }
