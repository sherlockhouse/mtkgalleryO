...
public class JsonParser {
    private final static String TAG = Log.Tag(JsonParser.class.getSimpleName());
    ...
    public int getValueIntFromObject(String objectName, String subObjectName,
        ...
        try {
            ...
            Log.e(TAG, "<getValueIntFromObject> warning, " + objectName + "." + subObjectName
                    + "." + propertyName);
            return INVALID_VALUE_INT;
        }
    }
    ...
    public double getValueDoubleFromObject(String objectName, String subObjectName,
        ...
        try {
            ...
            Log.e(TAG, "<getValueDoubleFromObject> warning, " + objectName + "." + subObjectName
                    + "." + propertyName);
            return INVALID_VALUE_DOUBLE;
        }
    }
    ...
    public String getValueStringFromObject(String objectName, String subObjectName,
        ...
        try {
            ...
            Log.e(TAG, "<getValueStringFromObject> warning, " + objectName + "." + subObjectName
                    + "." + propertyName);
            return "";
        }
    }
     ...
     */
    public boolean getValueBooleanFromObject(String objectName, String subObjectName,
                                            String propertyName) {
        boolean value = false;
        if (mJsonObject == null || objectName == null || propertyName == null) {
            Log.d(TAG, "<getValueBooleanFromObject> error!!");
            return false;
        }
        try {
            JSONObject object = mJsonObject.getJSONObject(objectName);
            object = subObjectName == null ? object : object.getJSONObject(subObjectName);
            if (object != null) {
                value = object.getBoolean(propertyName);
            }
            return value;
        } catch (JSONException exception) {
            Log.e(TAG, "<getValueBooleanFromObject> warning, " + objectName + "." + subObjectName
                    + "." + propertyName);
            return false;
        }
    }
    ...
    /**
     * Get boolean value from object or throw exception.
     * @param objectName
     *            object name
     * @param subObjectName
     *            sub object name
     ...
     *            property name
     * @return boolean value
     * @throws JSONException if no this property, throw exception
     */
    public boolean getValueBooleanOrThrow(String objectName, String subObjectName,
                                             String propertyName) throws JSONException {
         boolean value = false;
         if (mJsonObject == null || objectName == null || propertyName == null) {
             Log.d(TAG, "<getValueBooleanOrThrow> error!!");
             return false;
         }
         JSONObject object = mJsonObject.getJSONObject(objectName);
         object = subObjectName == null ? object : object.getJSONObject(subObjectName);
    ...
    public int[][] getInt2DArrayFromObject(String objectName, String arrayName) {
        ...
        try {
            ...
            Log.e(TAG, "<getInt2DArrayFromObject> warning, " + objectName + "." + arrayName);
            return null;
        }
    }
    ...
    public int[] getIntArrayFromObject(String objectName, String arrayName) {
        ...
        try {
            ...
            Log.e(TAG, "<getIntArrayFromObject> warning, " + objectName + "." + arrayName);
            return null;
        }
    }
    ...
    public int getObjectPropertyValueFromArray(String arrayName, int index, String propertyName) {
        ...
        try {
            ...
            Log.e(TAG, "<getObjectPropertyValueFromArray> warning, " + arrayName + "[" + index
                    + "]" + "." + propertyName);
            return -1;
        }
    }
    ...
    public int getArrayLength(String arrayName) {
        ...
        try {
            ...
            Log.e(TAG, "<getArrayLength> warning, " + arrayName);
            return -1;
        }
    }
}
