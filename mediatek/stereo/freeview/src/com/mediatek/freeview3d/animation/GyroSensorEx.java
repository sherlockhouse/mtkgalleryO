...
public class GyroSensorEx {
    private static final String TAG = Log.Tag("Fv/GyroSensorEx");
    ...
    public GyroSensorEx(Context context) {
        ...
        if (!mHasGyroSensor) {
            Log.d(TAG, "<GyroSensorEx>not has gyro sensor");
        }
    }
    ...
    private void registerGyroSensorListener() {
        if (mHasGyroSensor) {
            Log.d(TAG, "<registerGyroSensorListener> gyro sensor listener");
