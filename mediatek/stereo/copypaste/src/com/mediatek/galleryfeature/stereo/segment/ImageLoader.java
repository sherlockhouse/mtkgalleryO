...
public final class ImageLoader {
    private static final String LOGTAG = Log.Tag("Cp/ImageLoader");
    ...
    public static int getMetadataOrientation(Context context, Uri uri) {
        ...
        try {
            ...
            Log.e(LOGTAG, "<getMetadataOrientation> SQLiteException", e);
        } catch (IllegalArgumentException e) {
            Log.e(LOGTAG, "<getMetadataOrientation> IllegalArgumentException", e);
        } catch (IllegalStateException e) {
            Log.e(LOGTAG, "<getMetadataOrientation> IllegalStateException", e);
        } finally {
    ...
    public static Rect loadBitmapBounds(Context context, Uri uri) {
        if (uri == null || context == null) {
            Log.e(LOGTAG, "<loadBitmapBounds> uri or context maybe null ");
            return null;
        }
    ...
    public static Bitmap loadOrientedClearBitmap(Context context, Uri uri,
        ...
        if (uri == null || context == null) {
            Log.e(LOGTAG, "<loadOrientedClearBitmap> uri or context maybe null ");
            return null;
        }
