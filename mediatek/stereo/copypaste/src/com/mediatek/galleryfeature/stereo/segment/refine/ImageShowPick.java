...
public class ImageShowPick extends ImageShow implements StereoSegmentWrapper.IRedrawListener {
    private static final String LOGTAG = Log.Tag("Cp/ImageShowPick");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            Log.d(LOGTAG, "<onTouchEvent> mImgPos = {" + mImgPos[0] + ", " + mImgPos[1] + "}");
            Log.d(LOGTAG, "<onTouchEvent> mViewPos = {" + mViewPos[0]
                    + ", " + mViewPos[1] + "}");
    ...
    public void setSegmenter(StereoSegmentWrapper segmenter) {
        ...
        Log.d(LOGTAG, "<setSegmenter> imgWidth = " + imgWidth + ", imgHeight = " + imgHeight);
    ...
    protected void onVisibilityChanged(View changedView, int visibility) {
        if ((changedView == this) && (mMaskSimulator != null)) {
            if (visibility == VISIBLE) {
                ...
                int iY = (int) (mImgPos[1]);
                if (iX >= 0 || iY >= 0) {
                    Log.d(LOGTAG, "request to manualy pick object");
                    mMaskSimulator.setMaskCenter(iX, iY);
                } else {
                    Log.d(LOGTAG, "request to auto pick object");
