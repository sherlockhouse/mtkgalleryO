 ...
 */
public class Log {
    private static final String LOGTAG_PREFIX = "Stereo/";
    private static final String TAG = "Stereo/Log";
    ...
    private static final int LOG_LEVEL_IN_PROPERTY = SystemPropertyUtils.getInt(
            "debug.gallery.loglevel", CUST_LOG_LEVEL_I);
    private static final int CUST_LOG_LEVEL = LOG_LEVEL_IN_PROPERTY >= CUST_LOG_LEVEL_V
            && LOG_LEVEL_IN_PROPERTY <= CUST_LOG_LEVEL_E ? LOG_LEVEL_IN_PROPERTY : CUST_LOG_LEVEL_I;
    ...
    public static String Tag(String tag) {
        return new StringBuilder(LOGTAG_PREFIX).append(tag).toString();
    }
