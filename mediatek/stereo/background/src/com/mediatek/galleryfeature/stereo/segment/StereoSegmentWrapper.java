...
public class StereoSegmentWrapper {
    private static final String TAG = Log.Tag("Bg/StereoSegmentWrapper");
    ...
    private class DoSegmentInfo {
        ...
        public DoSegmentInfo(@NonNull DoSegmentInfo info) {
     ...
     * @exception IllegalArgumentException <code>inBitmap</code> is <code>null</code>.
     */
    public boolean initSegment(Uri sourceUri, String filePath, Bitmap inBitmap) {
        if (inBitmap == null) {
            Log.w(TAG, "<initSegment> inBitmap can not be null");
            return false;
        }
