...
public class BackgroundThumbTrack extends LinearLayout {
    private static final String LOGTAG = Log.Tag("Bg/BackgroundThumbTrack");
    ...
    public BackgroundThumbTrack(Context context, AttributeSet attrs) {
        ...
        mElemSize = r.getDimensionPixelSize(R.dimen.category_panel_icon_size);
    }
    ...
    public void onResume() {
        if (mAdapter != null) {
            Log.d(LOGTAG, "<onResume> register data observer " + mDataSetObserver);
    ...
    public void onPause() {
        if (mAdapter != null) {
            Log.d(LOGTAG, "<onPause> unregister data observer " + mDataSetObserver);
