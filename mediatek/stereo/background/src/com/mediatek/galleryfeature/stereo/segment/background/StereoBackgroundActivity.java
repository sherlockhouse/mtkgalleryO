...
public class StereoBackgroundActivity extends FragmentActivity {
    private static final String TAG = Log.Tag("Bg/StereoBackgroundActivity");

    private static final int ACTIONBAR_BACKGROUND_COLOR = 0x99333333;
    private static final String BACKGROUNDTHUMB_FRAGMENT_TAG = "ThumbPanel";
    ...
    private AtomicBoolean mSavingBackground = new AtomicBoolean(false);
    /**
     * Async task to load main bitmap for ImageShow.
     */
    private class LoadBitmapTask extends AsyncTask<Uri, Boolean, Boolean> {
        public boolean mUpdateSegmenterParameter ;
        @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.m_stereo_background_menu, menu);
        mMenu = menu;
        setupMenu();
        return true;
    }
    ...
    void changeBitmap(Uri uri) {
        ...
        if (mOriginalRefineImage == null) {
            ...
            Log.d(TAG, "<changeBitmap> mOriginalRefineImage = " + mOriginalRefineImage);
        }
    ...
    public void finish() {
        ...
        mForegroundSegmenterParameter = null;
        super.finish();
    }

    private void loadSegmentor() {
        if (mForegroundSegmenterParameter != null && mMaskSimulator == null) {
            mMaskSimulator = new StereoSegmentWrapper(this,
                    mForegroundSegmenterParameter.mOriginalWidth,
    ...
    private void startLoadBitmap(Uri uri) {
        ...
        mLoadBitmapTask = new LoadBitmapTask();
        mLoadBitmapTask.mUpdateSegmenterParameter = true;
        mLoadBitmapTask.execute(uri);
    }
    ...
    private void loadXML() {
        ...
        clickableRegion.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mSavingBackground.compareAndSet(false, true)) {
                    saveSynthedImage();
                }
            }
        });
    ...
    private void loadThumbPanel() {
        if (findViewById(R.id.main_panel_container) == null) {
            return;
        }
        BackgroundThumbPanel panel = new BackgroundThumbPanel();
