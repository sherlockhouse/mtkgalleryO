...
public class SegmentUtils {
    private static final String LOGTAG = Log.Tag("Bg/SegmentUtils");
     ...
     * @exception IllegalArgumentException <code>bitmap</code> is <code>null</code>.
     */
    ...
    public static Bitmap resizeBitmapByScale(Bitmap bitmap, float scale, boolean recycle) {
        ...
        if (width < 1 || height < 1) {
            Log.d(LOGTAG, "<resizeBitmapByScale> scaled width or height < 1, no need to resize");
            return bitmap;
        }
